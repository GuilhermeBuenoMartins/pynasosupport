...
def main(main_path: str, factor=.9, list_num_filters=[4, 8, 12, 16], list_kernel_size=[(3, 3), (5, 5)], batch_size=None,
    ...
    FILE_NAME = 'grid_lenet5_opening{}.log'.format(datetime.now().strftime('%Y-%m-%d_%H-%M-%S'))
    NUM_CLASSES = 2
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Create a Grid Lenet-5 Opening')
