...
from handlers.model import get_resnet34
...
def main(main_path: str, factor=.9, layer_type='Conv2D', list_num_filters=[4, 8, 12, 16], list_kernel_size=[(3, 3), (5, 5)], batch_size=None,
    ...
    lenet5_keras = KerasClassifier(build_fn=get_resnet34,
    ...
    grid = GridSearchCV(estimator=lenet5_keras, param_grid=grid_params, cv=2)
    if cpu_mode:
